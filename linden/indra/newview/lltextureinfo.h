...
public:
	...
	void setUpLogging(bool writeToViewerLog, bool sendToSim);
	bool has(const LLUUID& id);
	void setRequestStartTime(const LLUUID& id, U32 startTime);
	...
	void setRequestCompleteTimeAndLog(const LLUUID& id, U32 completeTime);
